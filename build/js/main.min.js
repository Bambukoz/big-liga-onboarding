...
Object(_modules_loader__WEBPACK_IMPORTED_MODULE_1__["loader"])();
...
var desktopMedia = window.matchMedia('(min-width: 1024px)').matches; // const tabletMedia = window.matchMedia("(min-width: 768px)").matches;
...
var showLeadBlock = function showLeadBlock() {};
