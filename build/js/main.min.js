...
Object(_modules_loader__WEBPACK_IMPORTED_MODULE_1__["pageLoader"])();
...
/* harmony import */ var _tablet_click__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./tablet-click */ "./js/modules/tablet-click.js");
...
var leadBlock = document.querySelector('.lead');
var tabletMedia = window.matchMedia('(max-width: 1023px)').matches;
...
var hiddenLoaderAfterTimeout = function hiddenLoaderAfterTimeout() {
  loader.classList.add(animationClass.LOADER_HIDDEN);
};

var activatePageHandler = function activatePageHandler() {
...
var activateTabletPageHandler = function activateTabletPageHandler() {
  activatePageHandler();
};

var activateDesktopPageHandler = function activateDesktopPageHandler(evt) {
...
var initLoader = function initLoader() {
  if (tabletMedia) {
    ...
    leadBlock.addEventListener('click', _tablet_click__WEBPACK_IMPORTED_MODULE_0__["swipeSlideHandler"]);
  } else {
...
/*!************************************!*\
  !*** ./js/modules/tablet-click.js ***!
  \************************************/
/*! exports provided: swipeSlideHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "swipeSlideHandler", function() { return swipeSlideHandler; });
var leadBlock = document.querySelector('.lead');
var animationClass = {
  LEAD_CLICKED: 'lead--clicked'
};

var swipeSlideHandler = function swipeSlideHandler() {
